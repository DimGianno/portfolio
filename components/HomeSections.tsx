...
export function FeaturedProjects() {
  const { t } = useSite();
  return (
    <AnimatedSection className="section" id="featured-projects">
        ...
        <div className="section-heading split-heading">
          ...
          <div>
            ...
            <Link href="/projects" className="text-link">
              {t.home.seeAll} <ArrowRight size={16} aria-hidden="true" />
            </Link>
          </div>
        </div>
  ...
  return (
    <AnimatedSection className="section">
      <div className="container social-panel">
        <div>
          <p className="eyebrow">{t.home.socialEyebrow}</p>
          <h2>{t.home.socialTitle}</h2>
          <p>{t.home.socialCopy}</p>
        </div>
...
export function CvCallout() {
  ...
  return (
    <AnimatedSection className="section section-last">
      <div className="container cv-callout">
        <div>
          <p className="eyebrow">{t.cv.eyebrow}</p>
          <h2>{t.home.cvTitle}</h2>
          <p>{t.home.cvCopy}</p>
        </div>
        <Link className="button button-primary" href="/cv">
          <FileText size={17} aria-hidden="true" /> {t.home.cvButton}
        </Link>
      </div>
    </AnimatedSection>
  );
